      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="card">
          <div className="mb-3 flex items-center justify-between">
            <h2>Audit Logs</h2>
            <button className="text-sm text-primary-600 underline" onClick={load}>Refresh</button>
          </div>
          ...
          {loading ? (
            ...
            <ul className="space-y-2 text-sm">
              {logs.map((log) => (
                <li key={log.id} className="flex items-center justify-between rounded bg-gray-50 p-3">
                  <div>
