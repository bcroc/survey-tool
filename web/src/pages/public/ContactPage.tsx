      ...
      <div className="mx-auto max-w-xl">
        <div className="card">
          ...
          <p className="mt-2 text-gray-600">
            Provide your contact if you want us to follow up. This is stored separately and cannot
          ...
          <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <button type="button" className="btn-secondary" onClick={() => navigate('/thanks')}>
                Skip
              </button>
            </div>
          </form>
